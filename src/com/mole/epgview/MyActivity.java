...
public class MyActivity extends Activity {
    ...
    private class Adapter extends EpgAdapter{
        int[] widths={15,50,40,70,25};
        /**
         * How many items are in the data set represented by this Adapter.
         *
         * @return Count of items.
         */
        @Override public int getChannelsCount() {
            return 15;
        }
         ...
         */
        @Override public int getEventsCount(int channel) {
            return 15;
        }
         ...
         */
        @Override public int getEventWidth(int channel, int event) {
         ...
         */
        @Override public boolean hasRegularData(int channel, int event) {
            return false;
        }
         ...
         */
        @Override public Object getItem(int channel) {
            return null;
        }
         ...
         * @return The data at the specified position.
         */
        @Override public Object getItem(int channel, int event) {
            return null;
        }
         ...
         * parameters using {@link com.mole.epgview.IEpgAdapter#getEventWidth(int, int)} unless you
         * use
         ...
         */
        @Override public View getView(int channel, int event, View convertView, ViewGroup parent) {
            convertView=new TextView(parent.getContext());
            ((TextView)convertView).setText("channel "+channel+", event "+event);
            return convertView;
        }
    }
}
